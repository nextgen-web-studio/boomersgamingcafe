...
const POWER_UP_MENU = {
  ...
  "tactical-starters": [
    ...
    { id: "f-9", name: "Korean Fried Chicken", price: 305, desc: "Crispy chicken tenders coated in a sweet and sticky glaze", popularity: "Bestseller", prep: "9 min", isVeg: false, calories: "450 kcal", rating: "4.9", spice: 2, ingredients: ["Chicken Tenders", "Gochujang Paste", "Sesame Seeds", "Honey Glaze"], image: "assets/images/Korean Fried Chicken.jpeg" },
    { id: "f-10", name: "Chicken Cheese Fries", price: 285, desc: "Crispy fries smothered in cheese sauce and chicken bites", popularity: "Heavy Loadout", prep: "8 min", isVeg: false, calories: "490 kcal", rating: "4.8", spice: 1, ingredients: ["Potatoes", "Shredded Roast Chicken", "Cheddar Melt", "Jalapeno Slices"], image: "assets/images/Chicken Cheese Fries.jpeg" },
    { id: "f-11", name: "Bang Bang Chicken Skewers", price: 315, desc: "Golden crispy chicken coated in sweet chili bang bang sauce", popularity: "Staff Pick", prep: "9 min", isVeg: false, calories: "380 kcal", rating: "4.7", spice: 2, ingredients: ["Chicken Breast Skewers", "Bang Bang Cream Sauce", "Green Onion Garnish"], image: "assets/images/Bang Bang Chicken Skewers.jpeg" },
    { id: "f-12", name: "Honey Chilli Chicken", price: 335, desc: "Tender chicken chunks tossed in sticky, sweet & spicy sauce", popularity: "Sweet & Spicy", prep: "8 min", isVeg: false, calories: "410 kcal", rating: "4.6", spice: 1, ingredients: ["Crispy Fried Chicken", "Wild Honey", "Red Chili Flakes", "Capsicum Mix"], image: "assets/images/Honey Chilli Chicken.jpeg" },
    { id: "f-13", name: "Buffalo Chicken", price: 325, desc: "Golden chicken pieces coated in zesty hot buffalo sauce", popularity: "Tangy Kick", prep: "8 min", isVeg: false, calories: "390 kcal", rating: "4.7", spice: 2, ingredients: ["Chicken Breast", "Zesty Buffalo Hot Sauce", "Butter Emulsion", "Celery Salt"], image: "assets/images/Buffalo Chicken.jpeg" },
    { id: "f-14", name: "Dragon Chicken", price: 355, desc: "Spicy, saucy chicken tenders with irresistible crunch", popularity: "Must Try", prep: "9 min", isVeg: false, calories: "430 kcal", rating: "4.9", spice: 3, ingredients: ["Slivered Chicken", "Cashews", "Red Chili Paste", "Soy Sauce Dressing"], image: "assets/images/Dragon Chicken.jpeg" },
    { id: "f-15", name: "BGC's OG Platter", price: 485, desc: "Generous serving of crispy golden fried chicken items", popularity: "Squad Value", prep: "12 min", isVeg: false, calories: "820 kcal", rating: "4.9", spice: 2, ingredients: ["Chicken Popcorn", "Korean Tenders", "Bang Bang Skewers", "Assorted House Dips"], image: "assets/images/BGC's OG Platter.jpeg" }
  ],
  "pasta": [
