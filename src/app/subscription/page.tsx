...
export default function SubscriptionPage() {
  ...
  const handleSubscribe = (tier: string, price: number) => {
    ...
    addToCart({
      gameId: `ps-plus-${tier.toLowerCase()}`,
      title: `PlayStation Plus ${tier}`,
      platform: "PS5 • PS4",
      coverImage: cover,
  ...
  return (
    <div className="min-h-screen bg-white text-black pb-24 font-sans">
      ...
      {/* Pricing Tiers (Side-by-Side just like PS Store) */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="flex flex-col bg-[#E6E6E6] text-black rounded-lg overflow-hidden transition-transform hover:-translate-y-2 duration-300">
            <div className="p-8 pb-4 flex-1">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <p className="text-xs font-bold tracking-widest text-gray-500 mb-1">PLAYSTATION PLUS</p>
              ...
              <Button onClick={() => handleSubscribe("Essential", 499)} className="w-full bg-[#E04F26] hover:bg-[#c94520] text-white rounded-full font-bold py-6 text-lg mb-8">
                Add to Cart
              </Button>
            ...
            <div className="bg-[#D9D9D9] p-4 text-center">
              <Link href="#" className="text-sm font-bold underline hover:text-gray-600">Explore Essential</Link>
            </div>
          </div>
          ...
          <div className="flex flex-col bg-[#F3C51A] text-black rounded-lg overflow-hidden transition-transform hover:-translate-y-2 duration-300 relative">
            <div className="p-8 pb-4 flex-1">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <p className="text-xs font-bold tracking-widest text-black/60 mb-1">PLAYSTATION PLUS</p>
              ...
              <div className="my-8">
                <p className="text-xs text-black/60 mb-1">1 Month</p>
                <div className="flex items-baseline gap-1">
                  <span className="text-3xl font-medium">₹749</span>
                </div>
              </div>

              <Button onClick={() => handleSubscribe("Extra", 749)} className="w-full bg-black hover:bg-gray-900 text-white rounded-full font-bold py-6 text-lg mb-8">
                Add to Cart
              </Button>
            ...
            <div className="bg-[#DEB317] p-4 text-center">
              <Link href="#" className="text-sm font-bold underline hover:text-black/70">Explore Extra</Link>
            </div>
          </div>
          ...
          <div className="flex flex-col bg-[#1A1A1A] text-white border border-gray-800 rounded-lg overflow-hidden transition-transform hover:-translate-y-2 duration-300">
            <div className="p-8 pb-4 flex-1">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <p className="text-xs font-bold tracking-widest text-gray-400 mb-1">PLAYSTATION PLUS</p>
                  <h3 className="text-4xl font-light tracking-tight">DELUXE</h3>
                </div>
              </div>
              <p className="text-gray-300 text-sm h-16">
                Enjoy all core PlayStation Plus benefits, hundreds of games in the Game Catalog, as well as exclusive benefits like game trials and the Classics Catalog.
              </p>
              
              <div className="my-8">
                <p className="text-xs text-gray-400 mb-1">1 Month</p>
                <div className="flex items-baseline gap-1">
                  <span className="text-3xl font-medium">₹849</span>
                </div>
              </div>

              <Button onClick={() => handleSubscribe("Deluxe", 849)} className="w-full bg-white hover:bg-gray-200 text-black rounded-full font-bold py-6 text-lg mb-8">
                Add to Cart
              </Button>

              <div className="space-y-4 text-sm font-medium">
                <div className="flex gap-4"><Check className="h-5 w-5 shrink-0" /> Classics Catalog</div>
                <div className="flex gap-4"><Check className="h-5 w-5 shrink-0" /> Game Trials</div>
                ...
                <div className="flex gap-4 text-gray-500"><Check className="h-5 w-5 shrink-0" /> Exclusive Content</div>
                <div className="flex gap-4 text-gray-500"><Check className="h-5 w-5 shrink-0" /> Cloud Storage</div>
                <div className="flex gap-4 text-gray-500"><Check className="h-5 w-5 shrink-0" /> Share Play</div>
              </div>
            </div>
            <div className="bg-[#121212] p-4 text-center border-t border-gray-800">
              <Link href="#" className="text-sm font-bold underline hover:text-gray-300">Explore Deluxe</Link>
            </div>
          </div>
      ...
      {/* Footer Info Text */}
      <div className="container mx-auto px-4 max-w-4xl mt-16 text-center text-gray-500 text-xs">
        <p>
          PlayStation Plus is an ongoing subscription with a recurring fee charged automatically at the frequency chosen at purchase until cancelled. Users must be 7 years or older and require parental consent if under 18.
        </p>
      </div>
    </div>
  );
